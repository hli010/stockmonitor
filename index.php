...
foreach ($stock_name_list as $stock){
	...
	echo "
<tr class=\"\"><td>
<a href=http://quote.eastmoney.com/$stock.html> $no </a> </td>
<script type=\"text/javascript\">
...
document.write(\"<tr><td>当前价格 </td><td> <font color=\"+color+\"> \" +elements[3] 
	+\"(\"
	+s_ele[1]
	+\",\"
	+s_ele[2]
...
document.write(\"<tr><td>市盈率   </td><td>  \" +stock_value_ele[39] +\"</td><tr>\");
document.write(\"<tr><td>总市值   </td><td>  \" +stock_value_ele[45] +\"</td><tr>\");
